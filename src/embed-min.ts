...
function createDotGlobeMin(options: EmbedMinOptions = {}) {
  const { container: containerOpt, nightImageUrl = EARTH_NIGHT_BASE64, dotSize = 1.0, minBrightness = 0.35, maxBrightness = 1.0, pulseSpeed = 1.0, pulseFrequency = 1.0, backgroundColor = 0x000000, backgroundOpacity = 1.0, dotColor = "#ffffff", tilt = [0, 0], rotationSpeed = 0.0008 } = options;
